...
<section class="rooms1 section-padding bg-cream" data-scroll-index="1">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="item">
                    <section class="video-wrapper video section-padding bg-img bg-fixed" data-overlay-dark="5" data-background="{{asset('uploads/pictures/'.$item->feature_photo)}}">
                        <div class="container">
                            <div class="row">
            ...
            <div class="col-md-6">
                <div class="item">
                    <div class="position-re o-hidden">
                        <a href="{{asset('uploads/pictures/'.$item->feature_photo ?? '' )}}" data-lightbox="HOTEL">
                            <img src="{{asset('uploads/pictures/'.$item->feature_photo ?? '' )}}" alt="">
                        </a>
                    </div>
                    <span class="category">
                        <a href="{{ route('branch.hotel',$item->id)}}" target="_blank"> Resort </a>
                    </span>
                    <div class="con">
                        <h5>
                            <a href="{{ route('branch.hotel',$item->id)}}" target="_blank"> {{$item->name ?? ''}} </a>
                        </h5>
                        <div class="line"></div>
                        <div class="row facilities">
                            ...
                            <div class="col col-md-5 text-end">
                                <div class="permalink">
                                    <a href="{{ route('branch.hotel',$item->id)}}" target="_blank">Details<i class="ti-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
