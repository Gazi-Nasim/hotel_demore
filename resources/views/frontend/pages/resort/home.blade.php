    ...
    @section('title', 'Hotel More Sajek Valley')
    @section('content')
        <!-- About -->
        ...
        <section class="rooms1 section-padding bg-cream" data-scroll-index="1">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="{{ asset('frontend') }}/img/rooms/1.jpg"
                    ...
                    <div class="col-md-4">
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="{{ asset('frontend') }}/img/rooms/2.jpg"
                                    alt=""> </div> <span class="category"><a href="rooms2.html">Book</a></span>
                            <div class="con">
                    ...
                    <div class="col-md-4">
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="{{ asset('frontend') }}/img/rooms/3.jpg"
                                    alt=""> </div> <span class="category"><a href="rooms2.html">Book</a></span>
                            <div class="con">
                    ...
                    <div class="col-md-6">
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="{{ asset('frontend') }}/img/rooms/4.jpg"
                                    alt=""> </div> <span class="category"><a href="rooms2.html">Book</a></span>
                            <div class="con">
                    ...
                    <div class="col-md-6">
                        <div class="item">
                            <div class="position-re o-hidden"> <img src="{{ asset('frontend') }}/img/rooms/7.jpg"
                                    alt=""> </div> <span class="category"><a href="rooms2.html">Book</a></span>
                            <div class="con">
                                <h6><a href="room-details.html">150$ / Night</a></h6>
        ...
        <section class="testimonials">
            <div class="background bg-img bg-fixed section-padding pb-0"
                data-background="{{ asset('frontend') }}/img/slider/2.jpg" data-overlay-dark="3">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <div class="testimonials-box">
                                ...
                                <div class="owl-carousel owl-theme">
                                    <div class="item">
                                        <span class="quote"><img src="{{ asset('frontend') }}/img/quot.png"
                                                alt=""></span>
                                        ...
                                        <div class="info">
                                            <div class="author-img"> <img src="{{ asset('frontend') }}/img/team/4.jpg"
                                                    alt=""> </div>
                                    ...
                                    <div class="item">
                                        ...
                                        <p>Hotel dapibus asue metus the nec feusiate eraten miss hendreri net ve ante the
                                            ...
                                            space, mus nellentesque habitan.</p>
                                        <div class="info">
                                            <div class="author-img"> <img src="{{ asset('frontend') }}/img/team/1.jpg"
                                                    alt=""> </div>
                                            <div class="cont"> <span><i class="star-rating"></i><i
                                                        class="star-rating"></i><i class="star-rating"></i><i
                                                        class="star-rating"></i><i class="star-rating"></i></span>
                                    ...
                                    <div class="item">
                                        ...
                                        <p>Hotel dapibus asue metus the nec feusiate eraten miss hendreri net ve ante the
                                            ...
                                            space, mus nellentesque habitan.</p>
                                        <div class="info">
                                            <div class="author-img"> <img src="{{ asset('frontend') }}/img/team/5.jpg"
                                                    alt=""> </div>
                                            <div class="cont"> <span><i class="star-rating"></i><i
                                                        class="star-rating"></i><i class="star-rating"></i><i
                                                        class="star-rating"></i><i class="star-rating"></i></span>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 p-0 animate-box" data-animate-effect="fadeInLeft">
                        <div class="img left">
                            <a href="restaurant.html"><img src="{{ asset('frontend') }}/img/restaurant/1.jpg"
                                    alt=""></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 p-0 order1 animate-box" data-animate-effect="fadeInRight">
                        <div class="img">
                            <a href="spa-wellness.html"><img src="{{ asset('frontend') }}/img/spa/3.jpg"
                                    alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 p-0 animate-box" data-animate-effect="fadeInLeft">
                        <div class="img left">
                            <a href="spa-wellness.html"><img src="{{ asset('frontend') }}/img/spa/2.jpg"
                                    alt=""></a>
                        </div>
                    </div>
                    <div class="col-md-6 p-0 bg-cream valign animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 p-0 order1 animate-box" data-animate-effect="fadeInRight">
                        <div class="img">
                            <a href="spa-wellness.html"><img src="{{ asset('frontend') }}/img/spa/1.jpg"
                                    alt=""></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="position-re o-hidden"> <img src="{{ asset('frontend') }}/img/news/1.jpg"
                                        alt="">
                                    <div class="date">
                            ...
                            <div class="item">
                                <div class="position-re o-hidden"> <img src="{{ asset('frontend') }}/img/news/2.jpg"
                                        alt="">
                                    <div class="date">
                            ...
                            <div class="item">
                                <div class="position-re o-hidden"> <img src="{{ asset('frontend') }}/img/news/3.jpg"
                                        alt="">
                                    <div class="date">
                            ...
                            <div class="item">
                                <div class="position-re o-hidden"> <img src="{{ asset('frontend') }}/img/news/4.jpg"
                                        alt="">
                                    <div class="date">
                            ...
                            <div class="item">
                                <div class="position-re o-hidden"> <img src="{{ asset('frontend') }}/img/news/6.jpg"
                                        alt="">
                                    <div class="date">
                                        <a href="post.html"> <span>Dec</span> <i>08</i> </a>
                                    </div>
                            ...
                            <div class="item">
                                <div class="position-re o-hidden"> <img src="{{ asset('frontend') }}/img/news/5.jpg"
                                        alt="">
                                    <div class="date">
                                        <a href="post.html"> <span>Dec</span> <i>08</i> </a>
                                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="owl-carousel owl-theme">
                            <div class="clients-logo">
                                <a href="#0"><img src="{{ asset('frontend') }}/img/clients/1.png"
                                        alt=""></a>
                            </div>
                            <div class="clients-logo">
                                <a href="#0"><img src="{{ asset('frontend') }}/img/clients/2.png"
                                        alt=""></a>
                            </div>
                            <div class="clients-logo">
                                <a href="#0"><img src="{{ asset('frontend') }}/img/clients/3.png"
                                        alt=""></a>
                            </div>
                            <div class="clients-logo">
                                <a href="#0"><img src="{{ asset('frontend') }}/img/clients/4.png"
                                        alt=""></a>
                            </div>
                            <div class="clients-logo">
                                <a href="#0"><img src="{{ asset('frontend') }}/img/clients/5.png"
                                        alt=""></a>
                            </div>
                            <div class="clients-logo">
                                <a href="#0"><img src="{{ asset('frontend') }}/img/clients/6.png"
                                        alt=""></a>
                            </div>
                        </div>
                    </div>
