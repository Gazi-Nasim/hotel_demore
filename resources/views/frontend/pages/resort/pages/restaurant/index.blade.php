...
<header class="header slider">
    <div class="owl-carousel owl-theme" style="height: 600px">
        ...
        <div class="text-center item bg-img" data-overlay-dark="5" data-background="{{ asset('uploads/pictures/'.$item->featured_photo ?? '' )}}">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-left">
                ...
                <div class="section-subtitle">{{ $room_data->name }}</div>
