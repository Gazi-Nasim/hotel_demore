...
<header class="header slider">
    <div class="owl-carousel owl-theme" style="height: 600px">
        ...
        <div class="text-center item bg-img" data-overlay-dark="5" data-background="{{ asset('uploads/pictures/'.$room->featured_photo ?? '' )}}">
            <img src="{{ asset('uploads/pictures/'.$room->featured_photo ?? '' )}}" alt="Picture">
        </div>       
        {{--<div class="text-center item bg-img" data-overlay-dark="5" data-background="{{ asset('frontend') }}/img/slider/3.jpg"></div>
        <div class="text-center item bg-img" data-overlay-dark="5" data-background="{{ asset('frontend') }}/img/slider/4.jpg"></div>
        <div class="text-center item bg-img" data-overlay-dark="5" data-background="{{ asset('frontend') }}/img/slider/5.jpg"></div>
        <div class="text-center item bg-img" data-overlay-dark="5" data-background="{{ asset('frontend') }}/img/slider/6.jpg"></div>--}}
    </div>
    {{-- <!-- arrow down -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-left">
                ...
                {{--{{$room}}--}}
                <div class="section-subtitle">{{ $room->name ?? '' }}</div>
                <div class="section-title">{{ $room_data->about_text ?? '' }}</div>
            </div>
            <div class="col-md-12">
                <p class="mb-30">{{ $room_data->about_banner ?? '' }}</p>
                <h6>Hours</h6>
                <ul class="list-unstyled page-list mb-30">
                    <li>
                        <div class="page-list-icon"> <span class="ti-time"></span> </div>
                        <div class="page-list-text">
                            <p>Breakfast: {{$room->breakfast ?? 'N/A'}}</p>
                        </div>
                    </li>
                    <li>
                        <div class="page-list-icon"> <span class="ti-time"></span> </div>
                        <div class="page-list-text">
                            <p>Lunch: {{$room->lunch ?? 'N/A'}}</p>
                        </div>
                    </li>
                    <li>
                        <div class="page-list-icon"> <span class="ti-time"></span> </div>
                        <div class="page-list-text">
                            <p>Dinner: {{$room->dinner ?? 'N/A'}}</p>
                        </div>
                    </li>
                </ul>
                <h6>Dress Code</h6>
